...
namespace bssn
{
    ...
    static const unsigned int BSSN_CONSTRAINT_NUM_VARS=10;
    ...
    /**@brief: minimum refinement level for BiB/SiS*/
    ...
    /***@brief: refinement method combination ordered from outer to inner grid*/
    extern unsigned int BSSN_REFINEMENT_MODE_COMBINATION_ORDER[2];
