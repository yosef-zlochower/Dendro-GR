...
bool BSSNCtx::is_remesh() {
    ...
    if (bssn::BSSN_REFINEMENT_MODE == bssn::RefinementMode::WAMR) {
        ...
        isRefine = bssn::isRemeshSiSCombination(
            m_uiMesh, m_uiBHLoc, (const double**)unzipVar, refineVarIds,
            bssn::BSSN_NUM_REFINE_VARS, waveletTolFunc, bssn::BSSN_DENDRO_AMR_FAC);
    } else if (bssn::BSSN_REFINEMENT_MODE == bssn::RefinementMode::CONSTRAINT) {
        isRefine = bssn::isRemeshConstraint(
            m_uiMesh, m_uiBHLoc, (const double**)unzipcVar, varId_grad2_chi,
            (const double**)unzipVar, bssn::VAR::U_CHI);
        ...
        isRefine = bssn::isReMeshWAMRConstraint(
            ...
            varId_grad_grad2_chi_expression, waveletTolFunc, bssn::BSSN_DENDRO_AMR_FAC);
    }
